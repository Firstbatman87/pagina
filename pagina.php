...
<body class="font-sans bg-gray-50">
    ...
    <div class="fixed bottom-6 right-6 z-50">
        <a href="https://wa.me/message/VRT3A6SPLAWLI1" class="bg-green-500 hover:bg-green-600 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-all transform hover:scale-110">
